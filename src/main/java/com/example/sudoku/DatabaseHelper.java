        ...
        try (Connection conn = DriverManager.getConnection(DB_URL);
            ...
            if (rs.next() && rs.getInt(1) == 0) {
                st.execute("""
                   ...
                   ('006100720000050004000003060007000080010709050080000600030500000100060000040009100', 'MEDIUM'),
                   ...
                   ('000000907000420180000705026100904000050000040000507009920108000034059000507000000', 'HARD'),
                   ('030050040008010500460000012070502080000603000040109030250000098001020600080060020', 'HARD'),
                   ('020810740700003100009002003030007050000040000060500070500900600001200800076053090', 'HARD'),
